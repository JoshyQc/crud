$(document).ready(function () {
    ...
    $(".editar").on('click', function () {
        ...
        $("<div class='edit_modal'><form name='edit' id='edit' method='post' action='http://localhost/crudFinal/instancias/edit_user.php'>" +
                ...
                "Editar": function () {
                    $.ajax({
                        ...
                        complete: function () {
                            ...
                            setTimeout(function () {
                                window.location.href = "http://localhost/crudFinal/vista/table.php";
                            }, 2000);
        ...
        $("<div class='delete_modal'>¡Estás seguro que deseas eliminar al usuario " + nombre + "?</div>").dialog({
            ...
            buttons: {
                "Eliminar": function () {
                    $.ajax({
                        type: 'POST',
                        url: 'http://localhost/crudFinal/instancias/delete_user.php',
                        async: true,
                        data: {id: id},
                        complete: function () {
    ...
    $(".agregar").on('click', function () {
        var id = $(this).attr('id');
        var nombre = $("#nombre" + id).html();
        $("<div class='insert_modal'><form name='insert' id='insert' method='post' action='http://localhost/crudFinal/instancias/insert_user.php'>" +
